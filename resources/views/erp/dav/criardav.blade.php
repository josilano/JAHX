...
@section('title', 'JahX Iniciar Pré-Venda')
...
@section('navigation')
    ...
    <div class="col l12 m12 s12 black">
        <h3 class="yellow-text text-accent-4 center-align">INICIAR PRÉ-VENDA</h3>
    </div>
@endsection
...
@section('content')
    ...
    <div class="table-container">
        <form action="{{ route('jahx.adddav') }}" method="post" id="form-create-prevenda">
            {{ csrf_field() }}
            ...
            <button class="btn waves-effect waves-light yellow accent-4 black-text" id="btn-send-venda" type="submit">Finalizar Pré-Venda
...
//            linhai++;
            ...
            cols += '<td><input type="tel" name="preco'+linhatabela+'" onchange="atualizasubtotal(\'qtd'+linhatabela+'\', \'preco'+linhatabela+'\', \'subtotal'+linhatabela+'\');" onKeyUp="maskIt(this,event,\'###.###.###,##\',true)"></td>';
