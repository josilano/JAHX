...
<head>
    ...
    <title>cupom de relatorio do mês</title>
    <style type="text/css">
        body {
            margin: 0 auto;
            margin-right: 5px;
...
<div>
    ...
    <span>------------------------------------------------------------------------------------</span><br>
    <div style="float: left; padding-top: -3px; padding-bottom: -3px;">{{ strftime('%d/%m/%Y %H:%M:%S') }}</div><div style="text-align: right; clear: right; padding-right: 4px; padding-top: -3px; padding-bottom: -3px;"></div>
    <span>------------------------------------------------------------------------------------</span>
    ...
    <span>------------------------------------------------------------------------------------</span><br>
    <div><strong>MES DO FATURAMENTO: {{ $data_da_venda }}</strong></div>
